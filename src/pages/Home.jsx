...
const Home = () => {
  ...
  return (
    <div className="bg-white min-h-screen selection:bg-blue-600 selection:text-white">
      ...
      {/* --- PREMIUM HERO SECTION (RESIZED & TOP COVERED) --- */}
      <section className="relative pt-0 pb-16 overflow-hidden bg-[#020617] min-h-[85vh] flex items-center">
        ...
        <div className="max-w-7xl mx-auto px-6 pt-35"> {/* Tazarar rubutu daga Navbar */}
          <div className="flex flex-col lg:flex-row items-center gap-10">            
            ...
            <div className="lg:w-1/2 relative group">
              <div className="relative z-10 bg-white/5 p-2 rounded-[2.5rem] shadow-2xl border border-white/10 backdrop-blur-sm transform hover:rotate-1 transition-transform duration-500">
                <img 
      ...
      <section id="services" className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 text-center mb-16">
          ...
          <h3 className="text-4xl font-black text-gray-900">Solutions Tailored For You</h3>
        </div>
        <PricingCard />
      </section>
      ...
      <section id="maintenance" className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 text-center mb-16">
          ...
          <h3 className="text-4xl font-black text-gray-900">Maintenance & Support</h3>
          <p className="text-gray-500 font-bold mt-2">We ensure your digital systems never stop growing.</p>
        </div>
        <MaintenancePlans />
      </section>
        ...
        <div className="max-w-5xl mx-auto bg-gradient-to-br from-blue-600 to-indigo-700 rounded-[3rem] p-12 lg:p-20 text-center relative overflow-hidden shadow-2xl">
          <div className="relative z-10">
            ...
            <button 
              ...
              className="px-12 py-5 bg-white text-blue-600 rounded-2xl font-black text-xl hover:scale-105 transition-transform flex items-center gap-3 mx-auto shadow-xl group"
            >
      ...
      {/* --- FOOTER --- */}
      <footer className="bg-[#020617] py-16 px-6 text-center border-t border-white/5">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex justify-center gap-8 mb-8 text-gray-400 font-black text-xs uppercase tracking-widest">
          ...
          <p className="text-gray-500 text-sm max-w-md mx-auto leading-relaxed font-medium">
            ...
            <span className="italic opacity-75 text-[10px]">Transforming ideas into digital impact, one pixel at a time.</span>
          </p>
        </div>
      </footer>
    </div>
