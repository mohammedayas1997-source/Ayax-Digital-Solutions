...
const Home = () => {
  ...
  return (
    <div className="bg-white min-h-screen selection:bg-blue-600 selection:text-white">
              ...
              <div className="flex flex-wrap items-center justify-start gap-4 mt-10">
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <X
                      size={14}
                      className="opacity-40 group-hover:text-red-400 transition-colors"
                    />
                  </div>
                </Link>
      ...
      {/* --- RE-ENGINEERED STUDENT INFRASTRUCTURE --- */}
      <section className="py-24 bg-sky-500 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            {/* Left Column: Action Hub */}
            <div className="space-y-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-900/10 border border-blue-900/20 rounded-full">
              ...
              <h2 className="text-6xl font-black text-blue-900 uppercase tracking-tighter leading-[0.9]">
                Student <br />{" "}
                <span className="text-white">Infrastructure</span>
              </h2>

              <p className="text-blue-900/80 text-lg font-medium max-w-md leading-relaxed">
                Empowering the next generation of technical leaders. Access your
                dashboard instantly to monitor progress and live project
                terminals.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-6">
                <Link
                  to="/enroll"
                  className="px-8 py-5 bg-blue-900 text-white rounded-2xl font-black text-xs uppercase tracking-[0.2em] hover:bg-black transition-all flex items-center justify-center gap-3 group shadow-2xl"
                >
                  <Cpu
                    size={20}
                ...
                <button
                  ...
                  className="px-8 py-5 bg-white text-blue-900 rounded-2xl font-black text-xs uppercase tracking-[0.2em] flex items-center justify-center gap-3 hover:bg-blue-50 transition-all group shadow-xl"
                >
                  Enter Portal
              ...
              <div className="grid grid-cols-2 gap-4 pt-8">
                <div className="p-8 bg-white/20 border border-white/30 rounded-[2rem] backdrop-blur-md">
            ...
            {/* Right Column: Visual Verification Hub */}
            <div className="space-y-6 relative">
              {/* Wrapped components for better layout flow */}
        ...
        <div className="max-w-5xl mx-auto bg-gradient-to-br from-blue-600 to-indigo-700 rounded-[3rem] p-12 lg:p-20 text-center relative overflow-hidden shadow-2xl shadow-blue-200">
          <div className="relative z-10">
            ...
            <p className="text-blue-100 text-lg mb-10 max-w-2xl mx-auto font-medium">
              Ready to take your business to the global stage? Our team is
              waiting to turn your ideas into powerful digital realities.
            </p>
            <button
              onClick={() =>
            ...
            >
              Get Started{" "}
              <MousePointer2 className="group-hover:translate-x-1 transition-transform" />
            </button>
          </div>
      ...
      <footer className="bg-[#020617] py-20 px-6 text-center border-t border-white/5">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-gray-500 text-xs max-w-md mx-auto leading-relaxed font-bold uppercase tracking-widest opacity-60">
            ...
            <span className="text-blue-900 mt-4 block">
