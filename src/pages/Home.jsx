              ...
              <div className="mt-12 flex items-center gap-6">
                <div className="flex -space-x-3">
                  {[1, 2, 3, 4].map((i) => (
                    <div
                      key={i}
                      className="w-10 h-10 rounded-full border-2 border-[#020617] bg-blue-600 flex items-center justify-center text-[10px] font-bold text-white uppercase"
                    >
                      AYAX
                    </div>
                  ))}
        ...
        <div className="max-w-7xl mx-auto px-6 flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="lg:w-1/2">
            ...
            <div className="flex flex-wrap items-center justify-start gap-4 mt-10 w-full mb-10">
              ...
              >
                ...
                <X
                  size={14}
                  className="ml-2 opacity-50 group-hover:opacity-100 group-hover:rotate-90 transition-all"
                />
              </Link>
            </div>
          ...
          <div className="lg:w-1/2 grid grid-cols-2 gap-4">
            ...
            <div className="p-8 bg-white/30 border border-white/40 rounded-3xl backdrop-blur-md">
              <p className="text-3xl font-black text-blue-900 mb-1 tracking-tighter text-left">
                24/7
              </p>
              <p className="text-[9px] font-black text-blue-800 uppercase tracking-widest text-left">
                Uptime Access
              </p>
            </div>
            <div className="p-8 bg-white/30 border border-white/40 rounded-3xl backdrop-blur-md">
