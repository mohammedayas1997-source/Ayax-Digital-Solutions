          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 animate-in fade-in duration-700">
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="mt-8 flex justify-between items-center bg-blue-50 p-6 rounded-[2rem] border border-blue-100">
                <div>
                  <h4 className="font-black text-blue-900 text-sm uppercase tracking-tight">Kammala Darasin Satin Nan?</h4>
                  <p className="text-[10px] text-blue-600 font-bold uppercase tracking-widest mt-1">Wannan zai sanar da Admin dinka ka gama.</p>
                </div>
                <button 
              ...
              <div className="bg-white p-10 rounded-[3rem] border border-gray-100 shadow-sm">
                ...
                <p className="text-slate-500 leading-relaxed font-medium">
                  Wannan shine babban darasinmu na wannan satin. Tabbatar ka kalli bidiyon nan duka sannan ka duba assignment dake kasa. 
