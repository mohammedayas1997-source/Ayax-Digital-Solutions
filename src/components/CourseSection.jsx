...
import { 
  Code2, Megaphone, ShieldAlert, BarChart3, ArrowUpRight, 
  Users, Timer, Trophy, CheckCircle2, Banknote // Na kara Banknote icon a nan
} from 'lucide-react';
  ...
  const courses = [
    {
      ...
      duration: "6 Months",
      fees: "30,000 Naira", // Price yana nan
    ...
    },
    {
      ...
      duration: "6 Months",
      fees: "30,000 Naira",
      level: "Advanced", // Na dawo da wannan don karka rasa ta
      accent: "red"
    },
    {
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
          <div className="max-w-2xl text-left">
            ...
            <p className="text-gray-500 mt-6 text-lg font-medium leading-relaxed">
              Industrial-grade training designed to transform students into elite tech architects.
            </p>
          </div>
          <div className="flex gap-4">
            <div className="bg-white p-6 rounded-[2rem] shadow-xl border border-gray-100 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm font-bold text-gray-900">Industry Expert</p>
              </div>
            </div>
          </div>
        </div>
            ...
            >
              ...
              <div className="p-8 text-left">
                ...
                <div className="space-y-4 mb-10">
                  ...
                  {/* NAN NE NA KARA FEES DIN YA BAYYANA */}
                  <div className="flex items-center gap-3 text-gray-900">
                    <Banknote className="w-4 h-4 text-amber-500" />
                    <span className="text-xs font-black uppercase tracking-wider">{course.fees}</span>
                  </div>

                  <div className="flex items-center gap-3 text-gray-600">
                    <CheckCircle2 className="w-4 h-4 text-emerald-500" />
                    <span className="text-xs font-bold uppercase tracking-wider">Live Projects Included</span>
                  </div>
                </div>
                ...
                >
                  <span className="relative z-10 flex items-center justify-center gap-2">
                    Enroll Now <ArrowUpRight className="w-4 h-4 group-hover/btn:translate-x-1 group-hover/btn:-translate-y-1 transition-transform" />
                  </span>
                </button>
              </div>
            </div>
